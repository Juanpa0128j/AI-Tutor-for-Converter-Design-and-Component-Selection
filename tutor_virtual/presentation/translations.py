TRANSLATIONS = {
    "en": {
        ...
        "main_header": "# ⚡ AI Tutor: Power Converter Designer",
        ...
        "calc_button": "🚀 Calculate Design",
        "report_header": "### 📊 Design Report",
        "report_placeholder": "Select a topology and press Calculate to see results.",
        "catalog_header": "### 🔌 Component Catalog",
        "tab_tutor": "Virtual Tutor",
        "tutor_header": "### 🎓 Expert Power Electronics Assistant",
        ...
        "msg_select_topo": "⚠️ Please select a topology.",
        "msg_invalid_topo": "⚠️ Invalid topology.",
        "msg_service_unavailable": "⚠️ Virtual Tutor service unavailable (check API Key).",
        # Documents tab
        "tab_documents": "Documents",
        "docs_header": "### 📚 Course Documents",
        ...
        "docs_status_success": "✅ Successfully indexed!",
        "docs_status_error": "❌ Error processing file",
        "docs_no_documents": "No documents uploaded yet.",
        "docs_delete_btn": "🗑️ Delete",
        "docs_refresh_btn": "🔄 Refresh",
        "docs_col_id": "ID",
        ...
        "topo_cuk_title": "Ćuk",
        "topo_cuk_desc": "Ćuk Converter in Continuous Mode",
    ...
    "es": {
        "app_title": "Diseñador de Convertidores de Potencia IA",
        "main_header": "# ⚡ AI Tutor: Diseñador de Convertidores de Potencia",
        "tab_designer": "Diseñador",
        "designer_intro": "Seleccione una topología, ingrese los parámetros y obtenga un prediseño con componentes recomendados.",
        "config_header": "### 1. Configuración",
        "topology_label": "Topología",
        "params_header": "### 2. Parámetros Operativos",
        "weights_header": "### 3. Priorización de Componentes",
        "weight_cost": "Costo",
        "weight_availability": "Disponibilidad",
        "weight_efficiency": "Eficiencia",
        "weight_thermal": "Térmica",
        "calc_button": "🚀 Calcular Diseño",
        "report_header": "### 📊 Reporte de Diseño",
        "report_placeholder": "Seleccione una topología y presione Calcular para ver los resultados.",
        "catalog_header": "### 🔌 Catálogo de Componentes",
        "tab_tutor": "Tutor Virtual",
        "tutor_header": "### 🎓 Asistente Experto en Electrónica de Potencia",
        "tutor_intro": "Pregunte sobre conceptos, topologías o pida explicaciones paso a paso.",
        "chat_title": "Chat con el Tutor",
        "col_type": "Tipo",
        "col_mfr": "Fabricante",
        "col_part": "Número de Parte",
        ...
        "col_datasheet": "Datasheet",
        "col_link": "Link",
        "ex_buck": "¿Qué es un convertidor Buck?",
        "ex_inductor": "Explícame paso a paso cómo seleccionar el inductor.",
        "ex_diff": "¿Cuál es la diferencia entre Buck y Boost?",
        "ex_freq": "¿Por qué es importante la frecuencia de conmutación?",
        "msg_select_topo": "⚠️ Por favor seleccione una topología.",
        "msg_invalid_topo": "⚠️ Topología inválida.",
        "msg_service_unavailable": "⚠️ El servicio de Tutor Virtual no está disponible (revise API Key).",
        # Documents tab
        "tab_documents": "Documentos",
        "docs_header": "### 📚 Documentos del Curso",
        ...
        "docs_status_processing": "🔄 Procesando...",
        "docs_status_success": "✅ ¡Indexado exitosamente!",
        "docs_status_error": "❌ Error procesando archivo",
        "docs_no_documents": "Aún no hay documentos subidos.",
        "docs_delete_btn": "🗑️ Eliminar",
        "docs_refresh_btn": "🔄 Actualizar",
        "docs_col_id": "ID",
        ...
        "topo_cuk_title": "Ćuk",
        "topo_cuk_desc": "Convertidor Ćuk en modo continuo",
        "topo_flyback_title": "Flyback",
        "topo_flyback_desc": "Convertidor Flyback aislado",
        "topo_rect_single_title": "Rectificador monofásico media onda",
        "topo_rect_single_desc": "Rectificador AC-DC básico",
        "topo_rect_full_title": "Rectificador puente monofásico",
        "topo_rect_full_desc": "Rectificador de onda completa",
        "topo_triac_title": "Control de fase TRIAC",
        "topo_triac_desc": "Regulador monofásico con TRIAC",
        "topo_inv_half_title": "Inversor medio puente",
        "topo_inv_half_desc": "Inversor DC-AC monofásico",
        "topo_inv_full_single_title": "Inversor puente completo monofásico",
        "topo_inv_full_single_desc": "Inversor SPWM clásico",
        "topo_inv_full_three_title": "Inversor trifásico",
        "topo_inv_full_three_desc": "Puente completo trifásico",
        "topo_pwm_title": "Modulación PWM",
        "topo_pwm_desc": "Parámetros de modulaciones SPWM/SVPWM",
        "lbl_vin": "Vin",
        "lbl_vo_target": "Vout deseada",
        "lbl_vo_target_neg": "Vout deseada (negativa)",
        "lbl_vo_target_any": "Vout (puede ser negativa)",
        "lbl_fsw": "Frecuencia de conmutación",
        "lbl_io_max": "Corriente de salida",
        "lbl_delta_il": "Rizo permitido IL",
        "lbl_delta_vo": "Rizo permitido Vo",
        "lbl_ripple_vo": "Rizo máximo Vo",
        "lbl_ripple_voltage": "Rizo máximo en voltaje",
        "lbl_vin_min": "Vin mínima",
        "lbl_vin_max": "Vin máxima",
        "lbl_pout": "Potencia de salida",
        "lbl_duty_max": "Duty máximo permitido",
        "lbl_turns_ratio": "Relación Np/Ns",
        "lbl_vac_rms": "Vac RMS",
        "lbl_freq_ac": "Frecuencia red",
        "lbl_load_resistance": "Carga R",
        "lbl_alpha_deg": "Ángulo de disparo",
        "lbl_vdc": "Vdc",
        "lbl_vo_rms": "Vo RMS",
        ...
        "lbl_mod_index": "Índice de modulación",
...
def get_text(key: str, lang_label: str = "Español") -> str:
